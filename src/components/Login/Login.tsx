    ...
    <>
      <div className="bg-white_A700 flex flex-col font-poppins items-start justify-end mx-auto pt-5 px-5 w-full">
        <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-[7px] mx-auto md:px-5 w-full">
            ...
            <div className="absolute flex flex-row sm:gap-10 h-max inset-[0] items-start justify-center m-auto w-[93%]">
              <div>
                <Img
                  ...
                  alt="internetEleven"
                />
                <Text className="ml-0.5 w-auto" as="h5" variant="h5">
                  aesthisia.com
                </Text>
              </div>
              <div className="flex flex-1 flex-row gap-1.5 h-[15px] md:h-auto items-start justify-start mt-[485px] w-full">
                <Img
          ...
          {/* Right Side */}
          <div className="flex md:flex-1 flex-col font-inter gap-7 items-center justify-start w-[33%] md:w-full">
            {/* Above Part */}
            ...
            <div className="flex flex-col items-start justify-start w-full">
              ...
              <Button
                className="cursor-pointer font-inter font-semibold h-[53px] mt-9 text-center text-lg text-white_A700 tracking-[-0.14px] w-[360px]"
                shape="RoundedBorder10"
                size="sm"
              ...
              >
                ...
                <span className="text-blue_gray_700 text-base font-inter font-medium">
                  {" "}
                </span>
              </Text>
            </div>
